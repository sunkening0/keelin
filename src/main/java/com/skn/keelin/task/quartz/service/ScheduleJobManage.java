...
/**
 * 
* 类名称：ScheduleJobFactoryManage   
* 类描述：  任务操作服务
* 创建人：skn   
* 创建时间：2019年8月26日 下午11:16:10   
* @version
 */
@Service
@Slf4j
public class ScheduleJobManage {
	 ...
	 * @param jobName
	 * @param jobGroupName
	 * @param jobTime  每隔多长时间执行一次任务
	 * @param jobTimes  执行几次  <0时不限制次数
	 * @param jobData
	 */
	 ...
	 * @param jobData
	 */
	public void saveCronJob(Class<? extends QuartzJobBean> jobClass, String jobName, String jobGroupName, String cron, Map jobData){
		log.info("新增任务");
		try {
            // 任务名称和组构成任务key
            JobDetail jobDetail = JobBuilder.newJob(jobClass).withIdentity(jobName, jobGroupName)
